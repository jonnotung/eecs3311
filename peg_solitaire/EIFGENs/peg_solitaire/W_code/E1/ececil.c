...
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5171, "test_easy_game_creation", closed [1].it_r))(closed [1].it_r);
}
...
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5175, "test_good_player_wins_easy_board", closed [1].it_r))(closed [1].it_r);
}
