...
extern EIF_TYPED_VALUE F412_1338(EIF_REFERENCE);
extern void F412_5206(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F412_1338 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 411, Current, 0, 0, 1689);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(411, Current, 1689);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F412_5206 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 411, Current, 0, 5205);
	RTSA(dtype);
	RTME(dtype, 0);
