...
extern EIF_TYPED_VALUE F202_4950(EIF_REFERENCE);
extern EIF_TYPED_VALUE F202_4951(EIF_REFERENCE);
extern EIF_TYPED_VALUE F202_4952(EIF_REFERENCE);
extern EIF_TYPED_VALUE F202_4954(EIF_REFERENCE);
extern void F202_4959(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F202_4950 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(3694,Dtype(Current)));
	return r;
}


/* {RT_DBG_VALUE_RECORD}.type */
EIF_TYPED_VALUE F202_4951 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(3695,Dtype(Current)));
	return r;
}


/* {RT_DBG_VALUE_RECORD}.breakable_info */
EIF_TYPED_VALUE F202_4952 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F202_4954 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 201, Current, 0, 0, 9902);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(201, Current, 9902);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	ur1 = tr2;
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2448, "plus", tr1))(tr1, ur1x)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
...
void F202_4959 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 201, Current, 0, 1, 9903);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(201, Current, 9903);
	RTCC(arg1, 201, l_feature_name, 1, RTWCT(3696, Dtype(Current), Dftype(Current)));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 3696, 0xF8000091, 0); /* breakable_info */
	
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(3696, Dtype(Current))) = (EIF_REFERENCE) RTCCL(arg1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
