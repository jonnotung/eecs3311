...
extern EIF_TYPED_VALUE F626_1360(EIF_REFERENCE);
...
EIF_TYPED_VALUE F626_1360 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 625, Current, 0, 0, 1811);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(625, Current, 1811);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1165, dtype))(Current)).it_b);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
