...
extern void F73_1231(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F73_1228 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 72, Current, 0, 0, 1274);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(72, Current, 1274);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(602, 29))(Current)).it_i4);
...
EIF_TYPED_VALUE F73_1229 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(1146,Dtype(Current)));
	return r;
}
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 72, Current, 0, 0, 1276);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(72, Current, 1276);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F73_1231 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 72, Current, 0, 1, 1277);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(72, Current, 1277);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 1146, 0x10000000, 1); /* error_code */
	
	*(EIF_INTEGER_32 *)(Current + RTWA(1146, Dtype(Current))) = (EIF_INTEGER_32) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
