...
EIF_TYPED_VALUE F67_1205 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 66, Current, 0, 0, 1251);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(66, Current, 1251);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(604, 29))(Current)).it_i4);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 66, Current, 0, 0, 1252);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(66, Current, 1252);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
