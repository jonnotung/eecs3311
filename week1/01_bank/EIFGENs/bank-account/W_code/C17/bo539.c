...
extern EIF_TYPED_VALUE F539_1338(EIF_REFERENCE);
extern void F539_5206(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F539_1338 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 538, Current, 0, 0, 1695);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(538, Current, 1695);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F539_5206 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 538, Current, 0, 5205);
	RTSA(dtype);
	RTME(dtype, 0);
