...
extern EIF_TYPED_VALUE F538_1340(EIF_REFERENCE);
extern EIF_TYPED_VALUE F538_1341(EIF_REFERENCE);
extern EIF_TYPED_VALUE F538_1342(EIF_REFERENCE);
extern EIF_TYPED_VALUE F538_1343(EIF_REFERENCE);
extern void F538_1344(EIF_REFERENCE);
extern void F538_5207(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F538_1340 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F538_1341 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F538_1342 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 537, Current, 0, 0, 1753);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(537, Current, 1753);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F538_1343 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 537, Current, 0, 0, 1754);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(537, Current, 1754);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F538_1344 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 537, Current, 0, 0, 1755);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(537, Current, 1755);
	RTIV(Current, RTAL);
...
void F538_5207 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 537, Current, 0, 5206);
	RTSA(dtype);
	RTME(dtype, 0);
