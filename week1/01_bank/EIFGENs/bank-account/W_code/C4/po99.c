...
extern EIF_TYPED_VALUE F99_1280(EIF_REFERENCE);
extern EIF_TYPED_VALUE F99_1281(EIF_REFERENCE);
...
EIF_TYPED_VALUE F99_1280 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 98, Current, 0, 0, 1326);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(98, Current, 1326);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(584, 29))(Current)).it_i4);
...
RTOID (F99_1281)
EIF_TYPED_VALUE F99_1281 (EIF_REFERENCE Current)
{
	GTCX
