...
static EIF_TYPE_INDEX gen_type0_113 [] = {213,112,0xFFFF};
...
static struct desc_info desc_113[] = {
	{(BODY_INDEX) 2070, (BODY_INDEX) -1, INVALID_DTYPE, NULL},
	{0, (BODY_INDEX)-1, 196, NULL},
	{1, (BODY_INDEX)-1, 213, gen_type0_113},
	...
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 112, NULL},
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 112, NULL},
	{2074, (BODY_INDEX)-1, 112, NULL},
	{2073, (BODY_INDEX)-1, 112, NULL},
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 112, NULL},
};
...
void Init113(void)
{
	...
	IDSC(desc_113 + 32, 72, 112);
	IDSC(desc_113 + 36, 225, 112);
	IDSC(desc_113 + 39, 246, 112);
}
