...
extern EIF_TYPED_VALUE F16_442(EIF_REFERENCE);
extern EIF_TYPED_VALUE F16_443(EIF_REFERENCE);
extern EIF_TYPED_VALUE F16_444(EIF_REFERENCE);
extern EIF_TYPED_VALUE F16_445(EIF_REFERENCE);
extern EIF_TYPED_VALUE F16_446(EIF_REFERENCE);
extern EIF_TYPED_VALUE F16_447(EIF_REFERENCE);
extern EIF_TYPED_VALUE F16_448(EIF_REFERENCE);
extern EIF_TYPED_VALUE F16_449(EIF_REFERENCE);
...
EIF_TYPED_VALUE F16_442 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F16_442,516,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F16_443)
EIF_TYPED_VALUE F16_443 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 15, Current, 0, 0, 516);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(15, Current, 516);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {211,196,0xFFFF};
...
RTOID (F16_444)
EIF_TYPED_VALUE F16_444 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 15, Current, 0, 0, 517);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
RTOID (F16_445)
EIF_TYPED_VALUE F16_445 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 15, Current, 0, 0, 518);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(15, Current, 518);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000DC, 0,0); /* Result */
...
RTOID (F16_446)
EIF_TYPED_VALUE F16_446 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 15, Current, 0, 0, 519);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(15, Current, 519);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000DC, 0,0); /* Result */
...
EIF_TYPED_VALUE F16_447 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F16_447,521,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F16_448 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F16_448,522,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F16_449 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F16_449,523,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
