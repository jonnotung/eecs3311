...
/* {VERSIONABLE}.version */
static EIF_TYPED_VALUE F2_35_body (EIF_REFERENCE Current)
{
	GTCX
...
void F2_37 (EIF_REFERENCE Current)
{
	...
	(*(EIF_NATURAL_32 *)(Current + RTWA(38, dtype))) += tu4_3;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
