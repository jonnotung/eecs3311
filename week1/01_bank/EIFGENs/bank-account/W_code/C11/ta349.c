...
extern void F349_1368(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F349_1368 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur8_1 ur8_1x.it_r8
	...
	RTEAA(l_feature_name, 348, Current, 0, 1, 1816);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(348, Current, 1816);
	RTIV(Current, RTAL);
