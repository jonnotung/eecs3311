...
extern EIF_TYPED_VALUE F241_1325(EIF_REFERENCE);
extern void F241_1328(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F241_5203(EIF_REFERENCE, int);
...
/* {BILINEAR}.off */
EIF_TYPED_VALUE F241_1325 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 240, Current, 0, 0, 1617);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(240, Current, 1617);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BILINEAR}.search */
void F241_1328 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 240, Current, 0, 1, 1618);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(240, Current, 1618);
	RTCC(arg1, 240, l_feature_name, 1, RTWCT(1173, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1189, dtype))(Current)).it_b);
...
/* {BILINEAR}._invariant */
void F241_5203 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 240, Current, 0, 5202);
	RTSA(dtype);
	RTME(dtype, 0);
