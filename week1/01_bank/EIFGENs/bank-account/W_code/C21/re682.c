...
extern EIF_TYPED_VALUE F682_1340(EIF_REFERENCE);
extern EIF_TYPED_VALUE F682_1341(EIF_REFERENCE);
extern EIF_TYPED_VALUE F682_1342(EIF_REFERENCE);
extern EIF_TYPED_VALUE F682_1343(EIF_REFERENCE);
extern void F682_1344(EIF_REFERENCE);
extern void F682_5207(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F682_1340 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F682_1341 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F682_1342 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 681, Current, 0, 0, 1765);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(681, Current, 1765);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F682_1343 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 681, Current, 0, 0, 1766);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(681, Current, 1766);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F682_1344 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 681, Current, 0, 0, 1767);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(681, Current, 1767);
	RTIV(Current, RTAL);
...
void F682_5207 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 681, Current, 0, 5206);
	RTSA(dtype);
	RTME(dtype, 0);
