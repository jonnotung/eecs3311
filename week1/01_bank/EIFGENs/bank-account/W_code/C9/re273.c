...
extern EIF_TYPED_VALUE F273_1340(EIF_REFERENCE);
extern EIF_TYPED_VALUE F273_1341(EIF_REFERENCE);
extern EIF_TYPED_VALUE F273_1342(EIF_REFERENCE);
extern EIF_TYPED_VALUE F273_1343(EIF_REFERENCE);
extern void F273_1344(EIF_REFERENCE);
extern void F273_5207(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F273_1340 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F273_1341 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F273_1342 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 272, Current, 0, 0, 1711);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(272, Current, 1711);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F273_1343 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 272, Current, 0, 0, 1712);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(272, Current, 1712);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F273_1344 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 272, Current, 0, 0, 1713);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(272, Current, 1713);
	RTIV(Current, RTAL);
...
void F273_5207 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 272, Current, 0, 5206);
	RTSA(dtype);
	RTME(dtype, 0);
