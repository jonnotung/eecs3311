...
static EIF_TYPE_INDEX gen_type0_46 [] = {213,45,0xFFFF};
...
static EIF_TYPE_INDEX gen_type4_46 [] = {237,201,0xFFFF};


static struct desc_info desc_46[] = {
	{(BODY_INDEX) -1, (BODY_INDEX) -1, INVALID_DTYPE, NULL},
	{0, (BODY_INDEX)-1, 196, NULL},
	{1, (BODY_INDEX)-1, 213, gen_type0_46},
	...
	{979, (BODY_INDEX)-1, 237, gen_type4_46},
};
...
void Init46(void)
{
	IDSC(desc_46, 0, 45);
	IDSC(desc_46 + 1, 2, 45);
	IDSC(desc_46 + 32, 163, 45);
	IDSC(desc_46 + 34, 157, 45);
}
