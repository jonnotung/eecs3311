...
extern void F64_1164(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F64_1165(EIF_REFERENCE);
extern EIF_TYPED_VALUE F64_1166(EIF_REFERENCE);
extern EIF_TYPED_VALUE F64_1167(EIF_REFERENCE);
...
void F64_1164 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 63, Current, 0, 2, 1210);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (arg1) {
		RTCC(arg1, 63, l_feature_name, 1, 196);
	}
	if (arg2) {
		{
			...
			RTCC(arg2, 63, l_feature_name, 2, typres0);
		}
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1095, 0xF80000FC, 0); /* case */
...
void F64_1165 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 63, Current, 3, 0, 1211);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if ((EIF_BOOLEAN) !loc1) {
		...
		ur1 = tr1;
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(3229, "item", loc2))(loc2, ur1x)).it_b);
...
EIF_TYPED_VALUE F64_1166 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 63, Current, 0, 0, 1212);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F64_1167 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
