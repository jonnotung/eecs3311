...
extern EIF_TYPED_VALUE F61_1126(EIF_REFERENCE);
...
RTOID (F61_1126)
EIF_TYPED_VALUE F61_1126 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 60, Current, 0, 0, 1175);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(60, Current, 1175);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
