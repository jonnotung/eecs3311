...
extern void F65_1168(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F65_1169(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F65_1170(EIF_REFERENCE);
extern EIF_TYPED_VALUE F65_1171(EIF_REFERENCE);
extern EIF_TYPED_VALUE F65_1172(EIF_REFERENCE);
...
void F65_1168 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 64, Current, 0, 2, 1214);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (arg1) {
		RTCC(arg1, 64, l_feature_name, 1, 196);
	}
	if (arg2) {
		{
			static EIF_TYPE_INDEX typarr0[] = {218,0,0xFFF9,0,145,0xFFFF};
			EIF_TYPE_INDEX typres0;
			static EIF_TYPE_INDEX typcache0 = INVALID_DTYPE;
			
			typres0 = (typcache0 != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(Dftype(Current), typarr0)));
			RTCC(arg2, 64, l_feature_name, 2, typres0);
		}
	}
	RTIV(Current, RTAL);
body:;
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1095, 0xF80000DA, 0); /* case */
	
	RTAR(Current, arg2);
	*(EIF_REFERENCE *)(Current + RTWA(1095, dtype)) = (EIF_REFERENCE) RTCCL(arg2);
	RTHOOK(2);
	...
	*(EIF_REFERENCE *)(Current + RTWA(1091, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTHOOK(3);
	RTDBGAA(Current, dtype, 1093, 0xF80000C4, 0); /* violation_tag */
	
	tr1 = RTMS_EX_H("",0,0);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(1093, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 1097, 0xF80000C4, 0); /* expected_tag_name */
...
void F65_1169 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 64, Current, 1, 3, 1215);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (arg3) {
		RTCC(arg3, 64, l_feature_name, 3, 196);
	}
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_REFERENCE *)(Current + RTWA(1093, dtype)) = (EIF_REFERENCE) tr1;
	...
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(1097, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(8);
	RTDBGAA(Current, dtype, 1092, 0xF80000C4, 0); /* bookmark_name */
...
void F65_1170 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 64, Current, 3, 0, 1216);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if ((EIF_BOOLEAN) !loc1) {
		...
		RTHOOK(3);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(3203, "apply", loc2))(loc2);
		
		RTHOOK(4);
		RTDBGAA(Current, dtype, 1089, 0x04000000, 1); /* passed */
		
		*(EIF_BOOLEAN *)(Current + RTWA(1089, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	}
	RTVI(Current, RTAL);
	RTRS;
	RTE_E
	...
	if (!tb2) {
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1097, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = RTCCL(tr1);
	...
	if (tb1) {
		...
		*(EIF_BOOLEAN *)(Current + RTWA(1089, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	} else {
		RTHOOK(7);
		RTDBGAA(Current, dtype, 1090, 0x04000000, 1); /* contract_violated */
		
		*(EIF_BOOLEAN *)(Current + RTWA(1090, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
		RTHOOK(8);
		RTCT0(NULL, EX_CHECK);
		...
		RTAR(Current, tr1);
		*(EIF_REFERENCE *)(Current + RTWA(1093, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(10);
		RTDBGAA(Current, dtype, 1094, 0x10000000, 1); /* violation_type */
		
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1069, dtype))(Current)).it_i4);
		*(EIF_INTEGER_32 *)(Current + RTWA(1094, dtype)) = (EIF_INTEGER_32) ti4_1;
	}
	RTHOOK(11);
...
EIF_TYPED_VALUE F65_1171 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 64, Current, 0, 0, 1217);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(64, Current, 1217);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F65_1172 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
