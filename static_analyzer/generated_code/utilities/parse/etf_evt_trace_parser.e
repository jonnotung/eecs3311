...
feature {NONE} -- Semantic actions
	...
	yy_do_action (yy_act: INTEGER)
		...
		do
				inspect yy_act
when 1 then
--|#line 82 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 82")
end
...
when 2 then
--|#line 89 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 89")
end
...
when 3 then
--|#line 94 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 94")
end
...
when 4 then
--|#line 99 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 99")
end
...
when 5 then
--|#line 106 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 106")
end
...
when 6 then
--|#line 112 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 112")
end
...
when 7 then
--|#line 119 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 119")
end
...
when 8 then
--|#line 121 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 121")
end
...
when 10 then
--|#line 126 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 126")
end
...
when 11 then
--|#line 132 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 132")
end
...
when 12 then
--|#line 137 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 137")
end
...
when 14 then
--|#line 145 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 145")
end
...
when 15 then
--|#line 149 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 149")
end
...
when 16 then
--|#line 153 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 153")
end
...
when 17 then
--|#line 157 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 157")
end

		create {ETF_INT_ARG}  yyval8.make(last_integer_value)  
...
when 18 then
--|#line 161 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 161")
end
...
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 165")
		...
		create {ETF_REAL_ARG} yyval8.make(last_real_value) 
		yyval8.set_src_out (last_string_value) -- see the scanner spec: the original string rep. is stored
...
when 20 then
--|#line 170 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 170")
end
...
when 21 then
--|#line 174 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 174")
end
...
when 22 then
--|#line 186 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 186")
end
...
when 23 then
--|#line 193 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 193")
end
...
when 26 then
--|#line 207 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 207")
end
...
when 27 then
--|#line 210 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 210")
end
...
when 28 then
--|#line 214 "ETF_evt_trace_parser_def.y"
debug ("GEYACC")
	std.error.put_line ("Executing parser user-code from file 'ETF_evt_trace_parser_def.y' at line 214")
end
...
feature {NONE} -- Table templates
	...
	yyr1_template: SPECIAL [INTEGER]
		...
		once
			Result := yyfixed_array (<<
			    0,   49,   41,   41,   41,   42,   42,   43,   43,   44,
			   44,   48,   48,   48,   48,   48,   48,   48,   48,   48,
			   48,   48,   45,   46,   46,   46,   47,   47,   47, yyDummy>>)
		end
	...
	yydefact_template: SPECIAL [INTEGER]
		...
		once
			Result := yyfixed_array (<<
			    2,    1,    4,    0,    0,    0,   26,   14,   13,   12,
			   11,   16,   15,   21,   19,   17,    0,    5,    7,    8,
			    9,   20,   18,   23,    0,   27,    3,    0,   24,    0,
			   10,    0,    6,    0,    0,   28,   22,   25,    0,    0,
			    0, yyDummy>>)
		end
	...
	yydefgoto_template: SPECIAL [INTEGER]
		...
		once
			Result := yyfixed_array (<<
			    1,   16,   17,   18,   19,   29,   24,   20,   38, yyDummy>>)
		end
	...
	yypact_template: SPECIAL [INTEGER]
		...
		once
			Result := yyfixed_array (<<
			 -32768,   32,    7,   -3,   41,   -2,   36, -32768, -32768, -32768,
			 -32768, -32768, -32768, -32768, -32768, -32768,  -13, -32768, -32768, -32768,
			 -32768, -32768, -32768,    2,    6, -32768, -32768,   -3, -32768,  -11,
			 -32768,   36, -32768,    0,    2, -32768, -32768, -32768,   14,   12,
			 -32768, yyDummy>>)
		end
	...
	yypgoto_template: SPECIAL [INTEGER]
		...
		once
			Result := yyfixed_array (<<
			 -32768, -32768,   19,   -7, -32768, -32768, -32768,    4, -32768, yyDummy>>)
		end
	...
	yytable_template: SPECIAL [INTEGER]
		...
		once
			Result := yyfixed_array (<<
			   ...
			   25,   27,   40,   34,   39,   26,   28,   10,    9,    8,
			    7,   33,   10,    9,    8,    7,    6,   37,    5,   23,
			   31,    6,   36,    4,    3,   35,   30,    2,    4,   15,
			   14,   13,   12,   11,   22,   21,   32,    0,    0,    0,
	...
	yycheck_template: SPECIAL [INTEGER]
		...
		once
			Result := yyfixed_array (<<
			    3,    4,    5,    6,    7,    3,    4,    5,    6,    7,
			    6,   24,    0,   24,    0,   28,   23,   20,   21,   22,
			   23,   32,   20,   21,   22,   23,   29,   34,   31,   31,
			   24,   29,   32,   36,   27,   31,   30,    5,   36,    3,
			    4,    5,    6,    7,    3,    4,   27,   -1,   -1,   -1,
