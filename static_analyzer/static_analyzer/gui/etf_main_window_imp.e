...
feature {NONE}-- Initialization
	...
	frozen initialize
		...
		do
			...
			execute.set_background_color (create {EV_COLOR}.make_with_8_bit_rgb (0, 0, 255))
			execute.set_foreground_color (create {EV_COLOR}.make_with_8_bit_rgb (255, 255, 255))
			execute.set_text ("Execute")
			reset.set_background_color (create {EV_COLOR}.make_with_8_bit_rgb (76, 183, 183))
			reset.set_foreground_color (create {EV_COLOR}.make_with_8_bit_rgb (255, 255, 255))
			reset.set_text ("Reset")
			load.set_background_color (create {EV_COLOR}.make_with_8_bit_rgb (8, 7, 246))
			load.set_foreground_color (create {EV_COLOR}.make_with_8_bit_rgb (255, 255, 255))
			load.set_text ("Load")
			output.disable_edit
			status_label.set_background_color (create {EV_COLOR}.make_with_8_bit_rgb (9, 2, 2))
