...
feature
	...
	make
		do
			...
			hash_set.put (create {SET_BINARY_CONSTRAINT [INTEGER_TYPE, SET_TYPE [INTEGER_TYPE]]}, {DIFFERENCE_OPERATOR})
			...
			hash_set.put (create {SET_BINARY_CONSTRAINT [INTEGER_TYPE, SET_TYPE [INTEGER_TYPE]]}, {UNION_OPERATOR})
		end
