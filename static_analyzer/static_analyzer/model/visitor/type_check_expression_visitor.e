...
feature
	...
	make
		do
			...
			hash_set.put (create {BINARY_CONSTRAINT [BOOLEAN_TYPE, BOOLEAN_TYPE]}, {AND_OPERATOR})
			...
			hash_set.put (create {BINARY_CONSTRAINT [SET_TYPE[BOOLEAN_TYPE], BOOLEAN_TYPE]}, {EXISTS_OPERATOR})
			hash_set.put (create {BINARY_CONSTRAINT [SET_TYPE[BOOLEAN_TYPE], BOOLEAN_TYPE]}, {FORALL_OPERATOR})
			hash_set.put (create {BINARY_CONSTRAINT [INTEGER_TYPE, BOOLEAN_TYPE]}, {GT_OPERATOR})
			hash_set.put (create {BINARY_CONSTRAINT [BOOLEAN_TYPE, BOOLEAN_TYPE]}, {IMPLIES_OPERATOR})
			hash_set.put (create {BINARY_CONSTRAINT [SET_TYPE[INTEGER_TYPE], SET_TYPE [INTEGER_TYPE]]}, {INTERSECT_OPERATOR})
			...
			hash_set.put (create {UNARY_CONSTRAINT [BOOLEAN_TYPE, BOOLEAN_TYPE]}, {NEGATION_OPERATOR})
			hash_set.put (create {UNARY_CONSTRAINT [INTEGER_TYPE, INTEGER_TYPE]}, {NEGATIVE_OPERATOR})
			hash_set.put (create {BINARY_CONSTRAINT [BOOLEAN_TYPE, BOOLEAN_TYPE]}, {OR_OPERATOR})
			hash_set.put (create {BINARY_CONSTRAINT [INTEGER_TYPE, INTEGER_TYPE]}, {PLUS_OPERATOR})
			hash_set.put (create {BINARY_CONSTRAINT [SET_TYPE[INTEGER_TYPE], INTEGER_TYPE]}, {SUM_OPERATOR})
