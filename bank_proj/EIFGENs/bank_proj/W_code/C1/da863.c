...
{
	GTCX
	RTOTC (F863_6991,12621,RTMS_EX_H("English",7,257590376));
}
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 862, Current, 0, 0, 12622);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 862, Current, 0, 0, 12624);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
{
	GTCX
	RTOTC (F863_6996,12626,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F863_6997,12627,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F863_6998,12628,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit863 (void)
{
	GTCX
	RTOTS (6991,F863_6991)
	RTOTS (6992,F863_6992)
	RTOTS (6993,F863_6993)
	RTOTS (6994,F863_6994)
	RTOTS (6995,F863_6995)
	RTOTS (6996,F863_6996)
	RTOTS (6997,F863_6997)
	RTOTS (6998,F863_6998)
}
