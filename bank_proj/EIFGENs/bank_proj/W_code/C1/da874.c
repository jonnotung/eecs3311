...
extern EIF_TYPED_VALUE F874_7124(EIF_REFERENCE);
extern EIF_TYPED_VALUE F874_7125(EIF_REFERENCE);
extern EIF_TYPED_VALUE F874_7126(EIF_REFERENCE);
...
EIF_TYPED_VALUE F874_7124 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F874_7125 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F874_7126 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 873, Current, 0, 0, 12739);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(5001, "fractional_second", tr1));
