...
extern EIF_TYPED_VALUE F875_7134(EIF_REFERENCE);
...
EIF_TYPED_VALUE F875_7134 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 874, Current, 0, 0, 12740);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ui4_2 = ti4_2;
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(5016, dtype))(Current, ui4_1x, ui4_2x)).it_i4);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
