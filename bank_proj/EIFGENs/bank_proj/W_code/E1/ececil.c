...
EIF_TYPED_VALUE _A878_76 (EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5089, "test_account_creation", closed [1].it_r))(closed [1].it_r);
}

	/* TEST_ACCOUNT test_account_withdraw */
EIF_TYPED_VALUE _A878_77 (EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5407, "test_account_withdraw", closed [1].it_r))(closed [1].it_r);
}

	/* TEST_ACCOUNT test_account_withdraw_precondition_is_not_too_weak */
void _A878_78 (void(*f_ptr) (EIF_REFERENCE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(5408, "test_account_withdraw_precondition_is_not_too_weak", closed [1].it_r))(closed [1].it_r);
}
